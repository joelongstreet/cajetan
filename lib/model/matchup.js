...
async function insert({
  ...
  const sql = `INSERT INTO matchup (team_a_id, team_b_id, team_a_score, team_b_score, team_a_is_home, team_b_is_home, odds_link, recap_link)
              VALUES (${teamAId}, ${teamBId}, ${teamAScore}, ${teamBScore}, ${teamAIsHome}, ${teamBIsHome}, '${oddsLink}', '${recapLink}')
              RETURNING *;`;
